<div class="btn-group" role="group" aria-label="...">
    ...
    @else
        <a type="button" class="btn btn-info" href="{{ action('HistopatologiaController@edit', $first->id) }}"><<</a>
    ...
    @else
            ...
            <a type="button" class="btn btn-info" href="{{ action('HistopatologiaController@edit', $last->id) }}" >>></a>
    @endif
</div>