<div class="row">
    ...
    <div class="col-md-8 form-group  {{ $errors->has('diagnostico') ? ' has-error' : '' }}">
        ...
        <textarea tabindex="2" name="diagnostico" id="diagnostico" class="form-control" cols="30" rows="2">@if(isset($item)){{ $item->diagnostico }}@endif</textarea>
    </div>
    ...
    <div class="col-md-8 form-group  {{ $errors->has('muestra') ? ' has-error' : '' }}">
        ...
        <textarea tabindex="3" name="muestra" class="form-control" id="muestra" cols="30" rows="2">@if(isset($item)){{ $item->muestra }}@endif</textarea>
    </div>
