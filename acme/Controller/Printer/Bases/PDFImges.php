...
class PDFImges extends baseFpdf
{
    ...
    function Header()
    {
        ...
        $this->SetFont('Helvetica', '', 10);
        //$this->setXY(32, 53);
        $this->MultiCell(171, 3, strtoupper(substr($this->data->diagnostico, 0, 140)),0, 'L', 0, 1, 32, 53, false, 0, false, true, '', 'B');
        /**
         * Salto
         */
        $this->ln();
        ...
        $this->SetFont('Helvetica', '', 10);
        $this->setX(47);
        $this->MultiCell(156  , 5, strtoupper(substr($this->data->muestra, 0, 140)), 0, 'L', false);
