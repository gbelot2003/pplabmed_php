    ...
    protected function PrintBody(Histopatologia $data, $pdf)
    {
        ...
        if (count($data->images) > 0 && count($data->images) <= 3) {
            ...
            if (count($data->images) == 1) {
                ...
                $pdf->writeHTMLCell(60, 10, 135, 120, $data->images[0]->descripcion, 0, 0, false, false, 'J', TRUE);
            }
            ...
            if (count($data->images) == 3) {
                ...
                $pdf->writeHTMLCell(60, 10, 135, 236, $data->images[2]->descripcion, 0, 0, false, false, 'L', TRUE);
            }
